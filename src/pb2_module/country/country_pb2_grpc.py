...
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../country'))
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proto/country_pb2_grpc.py depends on'
...
class CountryService(object):
    ...
    def GetAllCountries(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            proto_dot_country__pb2.Countries.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetCountryByName(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/proto.CountryService/GetCountryByName',
            proto_dot_country__pb2.CountryName.SerializeToString,
            proto_dot_country__pb2.Country.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
